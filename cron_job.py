...
if __name__ == '__main__':
    ...
    scheduler.add_job(getGamesJP, 'interval', days=1, start_date='2019-2-07 00:00:00')
    scheduler.add_job(getGamesAM, 'interval', days=1, start_date='2019-2-07 01:00:00')
    scheduler.add_job(getGamesEU, 'interval', days=1, start_date='2019-2-07 02:00:00')
